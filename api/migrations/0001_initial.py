# Generated by Django 3.0.5 on 2020-10-30 11:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(blank=True, validators=[api.models.validate_date], verbose_name='год')),
                ...
                ('genre', models.ManyToManyField(blank=True, db_index=True, related_name='titles', to='api.Genre', verbose_name='жанр')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
